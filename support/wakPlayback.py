...
class wakPlayback(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "WAK Playback")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("WAK Playback")
        ...
        self.settings = Qt.QSettings("GNU Radio", "wakPlayback")
        ...
        self.center_freq = center_freq = 2436084000
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/zee/rf/projects/porglet/support/PD_GCS.cfile', True, 0, 0)
...
def main(top_block_cls=wakPlayback, options=None):
